...
def crop_image(image_path, folderA, folderB, outputFolderA, outputFolderB):
    ...
    if key == 13:  # 13 is the Enter key
        ...
        if success:
            ...
            crop_and_save_images(folderA, outputFolderA, x, y, w, h)
            crop_and_save_images(folderB, outputFolderB, x, y, w, h)
